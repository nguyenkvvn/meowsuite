...
- **meowsplit** splits a .wav file into tracks based on the intervals of silence it can detect.
...
- **meowmvgen** collects all the mp3's in a working directory and makes a video out of them
